...
const BottomTab = ({
    ...
    return (
        <div className='main'>
            ...
            <ul>
                <li>
                    <input type="radio" name="item" id="one" defaultChecked={pathName === '/home'} onClick={handleTabClick} />
                    <label htmlFor="one">
                ...
                <li>
                    <input type="radio" name="item" id="two" defaultChecked={pathName === '/learn'} onClick={handleTabClick} />
                    <label htmlFor="two">
                ...
                <li>
                    <input type="radio" name="item" id="three" defaultChecked={pathName === '/code'} onClick={handleTabClick} />
                    <label htmlFor="three">
