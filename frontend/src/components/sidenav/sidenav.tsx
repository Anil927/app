...
const SideNav = () => {
    ...
    const handleTabChange = async (e: any) => {
        if (e === 'one' && pathName !== '/home/createpost' && pathName !== '/home/readmore') {
            setPageHeading('Home')
            router.push('/home')
        } else if (e === 'two') {
    ...
    useEffect(() => {
        ...
        } else if (pathName.includes('/readmore')) {
            setPageHeading(`<div>Home</div>${arrowSymbol}<div>Post</div>`);
    ...
    return (
        <div>
            ...
            <div className={`backdrop ${drawerOpen ? 'active': ''}`} onClick={toggleDrawer}></div>
