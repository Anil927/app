...
const BottomTab = ({
    ...
    useEffect(() => {
        ...
        } else if (pathName === '/discuss' || pathName === '/discuss/ask' || pathName === '/discuss/question') {
            checkRadioButtonById('four');
        } else if (pathName === '/profile' || pathName === '/profile/useractivity' || pathName === '/profile/userdownloads') {
