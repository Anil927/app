...
const QnAFormat: React.FC<QnAProps> = ({ id }) => {
    ...
    const questionOrAnswerType = 'answere'; // needs to be fetched from backend using the id
            ...
            <>
                <div className='qna-format'>
                    ...
                    <div className="qna-content">
                        ...
                        {(questionOrAnswerType !== 'answered') && <button onClick={() => setIsAnsweringQuestion(!isAnsweringQuestion)} className='answer-btn'>Give Your Answer</button>}
                    </div>
                </div>
                {isAnsweringQuestion && <Editor value='' onPublish={handlePublish} />}
            </>
            :
            <div>
